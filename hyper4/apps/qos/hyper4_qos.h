...
#ifndef CONTROLLER_HYPER4_QOS_H
#define CONTROLLER_HYPER4_QOS_H


#include "../hyper4_app.h"
#include "../../hyper4.h"

class hyper4_qos : public hyper4_app{
public:
    hyper4_qos(pi_dev_id_t dev_id,
               uint8_t program_id,
               uint8_t start_stage,
